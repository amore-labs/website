...
def validate_entry(publication):
    allowed = {"title", "authors", "year", "preprint", "published_url", "venue", "github"}
    disallowed = set(publication.keys()) - allowed
    assert not disallowed, f"Fields {disallowed!r} not allowed for publication {publication!r}."
